#!/usr/bin/env python3
"""
PowerPoint Generator for "Miracles Are Easy — Verses"
...
def create_miracles_presentation():
    ...
    title.text = "Miracles Are Easy"
    subtitle.text = "Verses"
    ...
    # Save presentation
    output_file = "Miracles_Are_Easy_Verses.pptx"
    prs.save(output_file)
    print(f"PowerPoint presentation saved as: {output_file}")
    return output_file

if __name__ == "__main__":
    create_miracles_presentation()
